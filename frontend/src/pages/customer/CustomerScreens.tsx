    ...
    <div className="max-w-[600px] mx-auto">
      ...
      <BentoCard className="bg-white">
        <div className="flex items-center gap-6 mb-8 pb-8 border-b border-[#d2d2d7]/50">
           <div className="w-24 h-24 rounded-pill bg-[#e8e8ed] overflow-hidden shrink-0">
         ...
         <div className="flex-1 bg-[#e8e8ed] relative">
            ...
            <div className="absolute bottom-6 left-6 right-6 text-white">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                <span className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-pill text-[13px] font-medium">Sạch sẽ</span>
                <span className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-pill text-[13px] font-medium">Ít nấu ăn</span>
                <span className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-pill text-[13px] font-medium">Ngủ sớm</span>
              </div>
            </div>
         </div>
    ...
    <div>
      ...
      <BentoCard className="bg-white p-6">
        <div className="flex items-center gap-4 text-[#1d1d1f] py-4 border-b border-[#d2d2d7]/50 last:border-0">
          <div className="w-12 h-12 rounded-pill bg-[#ff9500]/10 text-[#ff9500] flex items-center justify-center shrink-0">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <BentoCard className="bg-white p-4 flex flex-col gap-3">
          <div className="w-full h-[180px] rounded-[12px] bg-[#e8e8ed] overflow-hidden relative">
            ...
            <button className="absolute top-2 right-2 p-2 bg-white/70 backdrop-blur-md rounded-pill text-[#ff3b30]">
              <Heart  />
            </button>
          </div>
