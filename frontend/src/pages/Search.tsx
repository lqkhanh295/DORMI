        ...
        <div className="mb-8 md:mb-10 w-full">
          <div className="relative flex w-full max-w-[600px] items-center mx-auto">
            ...
            <input 
              ...
              className="h-[50px] md:h-[56px] w-full rounded-pill bg-white pl-11 md:pl-12 pr-20 md:pr-24 text-[15px] md:text-[17px] shadow-sm outline-none transition-all focus:ring-4 focus:ring-primary/20"
            />
            {searchQuery && (
              <button 
            ...
            {[1, 2, 3].map((i) => (
              <BentoCard key={i} noPadding className="bg-white flex flex-col h-[380px] md:h-[420px] animate-pulse">
                ...
                <div className="flex flex-1 flex-col justify-between p-5 md:p-6">
                  <div>
                    <div className="h-3 w-16 bg-neutral-200 rounded-pill mb-3"></div>
                    <div className="h-6 w-full bg-neutral-200 rounded-md mb-2"></div>
                  ...
                  <div className="flex items-center justify-between pt-4 mt-4 border-t border-border-subtle">
                    ...
                    <div className="h-8 w-24 bg-neutral-200 rounded-pill"></div>
                  </div>
                </div>
              </BentoCard>
            ))}
              ...
              {results.map((room) => (
                <BentoCard key={room.id} noPadding hoverEffect className="bg-white flex flex-col h-[380px] md:h-[420px]">
                  <div className="relative h-[200px] md:h-[220px] w-full shrink-0 overflow-hidden bg-surface-alt">
                    ...
                    />
                    <div className="absolute left-3 top-3 md:left-4 md:top-4 rounded-pill bg-[rgba(255,255,255,0.9)] px-2 md:px-3 py-1 text-[11px] md:text-[12px] font-bold text-foreground shadow-sm backdrop-blur-md">
                      {room.badge}
                    </div>
                  </div>
